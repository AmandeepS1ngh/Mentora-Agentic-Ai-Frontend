                        ...
                        <main className="container mx-auto px-4 py-8 pb-24 relative z-10 max-w-7xl">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                                ...
                                <div className={cn(
                                    ...
                                    <div className="flex-1 bg-card/30 rounded-3xl border border-white/5 backdrop-blur-sm p-4 overflow-hidden flex flex-col">
                                        {/* Toggle Tabs for AI Summary / Tasks */}
                                        <div className="flex items-center gap-2 p-1 bg-background/50 rounded-xl border border-white/5 w-fit mb-4">
                                            <button
                                                onClick={() => setExpandedTaskId(null)}
                                                className={`px-4 py-2 rounded-lg text-sm font-medium transition-all flex items-center gap-2 ${expandedTaskId === null
                                                    ? "bg-primary text-primary-foreground shadow-sm"
                                                    : "text-muted-foreground hover:text-foreground"
                                                    }`}
                                            >
                                            ...
                                            <button
                                                onClick={() => setExpandedTaskId("summary")}
                                                className={`px-4 py-2 rounded-lg text-sm font-medium transition-all flex items-center gap-2 ${expandedTaskId === "summary"
                                                    ? "bg-primary text-primary-foreground shadow-sm"
                                                    : "text-muted-foreground hover:text-foreground"
                                                    }`}
                                            >
                                        ...
                                        <div className="flex-1 flex flex-col overflow-hidden">
                                            {/* AI Summary View */}
                                            {expandedTaskId === "summary" && (
                                                <div className="flex-1 rounded-xl border border-border/50 bg-card/50 p-4 overflow-y-auto">
